...
class BinomialCoefficients: 
    ...
    def __init__(self):
        ...
        self.overflow: List[List[bool]] = [[False] * (self.M + 1) for _ in range(self.M + 1)]
        ...
        for n in range(2, self.M + 1): 
            for k in range(1, n):
                ...
                self.overflow[n][k] = self.overflow[n-1][k-1] or self.overflow[n-1][k]
                if self.binom[n][k] < self.binom[n - 1][k - 1] or self.binom [n][k] < self.binom [n - 1][k]:
